          ...
          <Col className="d-flex justify-content-center flex-wrap">
            <div className="m-2">
              <a href="mailto:akjha96@gmail.com" target="_blank" rel="noopener noreferrer">
                <Button className="buttonIcon" variant="outline-danger" title="akjha96@gmail.com">
            ...
            <div className="m-2">
              <a href="https://www.linkedin.com/in/anand-kumar-jha-745798a4/" target="_blank" rel="noopener noreferrer">
                <Button className="buttonIcon" variant="outline-primary" title="Visit my LinkenIn">
            ...
            <div className="m-2">
              <a href="https://github.com/akjha96" target="_blank" rel="noopener noreferrer">
                <Button className="buttonIcon" variant="outline-dark" title="My other projects">
            ...
            <div className="m-2">
              <a href="https://www.youtube.com/user/MrAkjha96/" target="_blank" rel="noopener noreferrer">
                <Button className="buttonIcon" id="youtube-btn" variant="outline-info" title="Lets code together!">
            ...
            <div className="m-2">
              <a href="https://twitter.com/akjha96" target="_blank" rel="noopener noreferrer">
                <Button className="buttonIcon" variant="outline-info" title="Tweets are welcomed!">
            ...
            <div className="m-2">
              <a href="https://www.facebook.com/akjha132" target="_blank" rel="noopener noreferrer">
                <Button className="buttonIcon" variant="outline-primary" title="Say hello on FB">
